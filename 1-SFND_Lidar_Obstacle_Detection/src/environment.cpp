...
//#define PCL_STANDART_METHOD
#define CUSTOM_MADE_METHOD
...
void simpleHighway(pcl::visualization::PCLVisualizer::Ptr& viewer)
{
    ...
    typename pcl::PointCloud<pcl::PointXYZ>::Ptr inputCloud = lidar->scan();
...
void cityBlock(pcl::visualization::PCLVisualizer::Ptr& viewer, ProcessPointClouds<pcl::PointXYZI>* pointProcessorI, pcl::PointCloud<pcl::PointXYZI>::Ptr& inputCloud)
{
  ...
  // ----------------------------------------------------
    ...
    pcl::PointCloud<pcl::PointXYZI>::Ptr filterCloud = pointProcessorI->FilterCloud(inputCloud, 0.2, Eigen::Vector4f(-15, -6.0, -3, 1), Eigen::Vector4f(30, 6.0, 10, 1));
    ...
    #if defined PCL_STANDART_METHOD
        std::vector<typename pcl::PointCloud<pcl::PointXYZI>::Ptr> cloudClusters = pointProcessorI->Clustering(segmentCloud.first, 0.3, 15, 700);
	#elif defined CUSTOM_MADE_METHOD
        std::vector<typename pcl::PointCloud<pcl::PointXYZI>::Ptr> cloudClusters = pointProcessorI->clusteringImplementation(segmentCloud.first, 0.33, 10, 700);
    #endif
